...
public class ATLAS_1081_Sprint3_TC_124_125_126 extends BaseTest
{
	...
	@Test
	public void EditingMasterQLIs() throws Exception
	{
		...
		// Creating Opportunity , Quote and QuoteLine
			...
			opp.QuoteLinesSection();
			opp.fillQuoteLiesDetailsAfterValidation("GCP HQ", "2000");
			opp.fillQuoteLiesDetailsAfterValidation("Australia", "2000");
