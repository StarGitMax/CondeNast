...
public class ATLAS_675_Sprint7_TC_2434_2435 extends BaseTest
{
	...
	public void ValidateMarketAccounts() throws Exception
	{
	    ...
	    ma.SearchandClickMarketAccount(AccountName_TC2434_2435);
	    ...
	    ma.ClickonMarketAccounts();
	    ma.VerifyDeleteOptionforMarketAccount(AccountName_TC2434_2435);
