...
public class ATLAS_623_Sprint5_TC_1787 extends BaseTest
{
	...
	@Test
	public void ValidateOpportunityStageDownwardsfrom100() throws Exception
	{
		sl.NavigateandLogin();
		...
		OppName = OppName.replace("AUT-GCP HQ:", "TEC-GCP HQ:");
		opp.LogoutofSalesForceUser(sfUser_SA);
		
		
		opp.LoginAsDifferentUsers2(sfUser_SL);
		opp.ClickonOpportunities();
