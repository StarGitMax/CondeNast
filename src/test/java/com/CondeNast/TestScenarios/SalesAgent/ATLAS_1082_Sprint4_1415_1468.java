...
public class ATLAS_1082_Sprint4_1415_1468 extends BaseTest
{
	...
	@Test
	public void ValidateStagetoallotherstagesfrom10() throws Exception
	{
		sl.NavigateandLogin();
		...
		opp.EditQuoteLine(sname);
		Thread.sleep(10000);
		opp.selectQLIStage("Closed Lost (0%)");
		opp.SaveQuoteLineItem();
		getQLIdate();
