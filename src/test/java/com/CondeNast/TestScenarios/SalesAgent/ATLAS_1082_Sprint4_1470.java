...
public class ATLAS_1082_Sprint4_1470 extends BaseTest
{
	...
	@Test
	public void ValidateStagetoallotherstagesDownfrom75() throws Exception
	{
		sl.NavigateandLogin();
	...
	public void createQuoteLine(String stage) throws Exception
	{
	    ...
	    uiDriver.SetValueForTextBox("StartDate","10/01/2021");
		uiDriver.SetValueForTextBox("EndDate", "29/06/2021");
