...
public class ATLAS_623_Sprint5_TC_1799 extends BaseTest
{
	...
	@Test
	public void VeirfyOpportunityisnoeditablewithUnallocatedbalacepresent() throws Exception
	{
		sl.NavigateandLogin();
		...
		String sval = opp.fillOpportunitiesForm(AccountName,"18000","01/03/2021","IdentifyingOpportunity","CentrallyBilled");
