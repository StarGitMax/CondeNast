...
public class ATLAS_623_Sprint5_TC_1776 extends BaseTest
{
	...
	@Test
	public void ValidateOpportunityStage10to50() throws Exception
	{
		sl.NavigateandLogin();
		...
		String sval = opp.fillOpportunitiesForm(AccountName,"18000","13/02/2021","IdentifyingOpportunity","CentrallyBilled");
