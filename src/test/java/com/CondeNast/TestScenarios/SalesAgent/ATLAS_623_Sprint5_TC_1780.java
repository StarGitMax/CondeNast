...
public class ATLAS_623_Sprint5_TC_1780 extends BaseTest
{ 
	...
	@Test
	public void ValidateOpportunityStagefrom90toUpwords() throws Exception
	{
		sl.NavigateandLogin();
		...
		String sval = opp.fillOpportunitiesForm(AccountName,"3000","25/02/2021","IdentifyingOpportunity","CentrallyBilled");
