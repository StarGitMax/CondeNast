...
public class ATLAS_1082_Sprint4_1478 extends BaseTest
{
	...
	@Test
	public void ValidateStagewhenZeropercent() throws Exception
	{
		sl.NavigateandLogin();
		...
		opp.fillOpportunitiesForm(AccountName,"18000","20/02/2021","IdentifyingOpportunity","CentrallyBilled");
		...
		Thread.sleep(5000);
		try {
			WebElement val=driver.findElement(By.xpath("(//span[text()='Stage'])[2]"));
			...
			// TODO Auto-generated catch block
			String img1 = uiDriver.CaptureFullScreenShot("Stage");
