...
public class ATLAS_623_Sprint5_TC_1800 extends BaseTest
{
	...
	@Test
	public void VeirfyUnabletosetStageOpportunityto100ifQLIis100orZero() throws Exception
	{
		sl.NavigateandLogin();
		...
		String sval = opp.fillOpportunitiesForm(AccountName,"6000","12/02/2021","IdentifyingOpportunity","CentrallyBilled");
        ...
        {
        	sname = sdat.get(k).get("NAME").toString();
    		System.out.println("Name : " +sname);
    		// Closed Won (100%) and Closed Lost (0%)
    		opp.EditQuoteLine(sname);
    		if(k==2)
    		{
    			uiDriver.SetValueForList("QLStage", LIST.ByVisibleText, "Closed Lost (0%)");
    		}
    		else
    		{
