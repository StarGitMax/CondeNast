...
public class ATLAS_1120_Sprint5_TC_1698_1699_1700 extends BaseTest
{
	...
	public void ValidateRLIforchangeinDates() throws Exception
	{
		...
		opp.FillQuoteLineItemFields("18000","16/01/2021","30/06/2021","Digital");
		...
		ValidateRLIfor4quaters("01/12/2020","30/09/2021");
		opp.SaveQuoteLineItem();
		opp.EditQuoteLine(sname);
		ValidateRLIchangequaters("01/12/2020","31/01/2021");
		opp.CloseErrorPopUp();
		opp.CloseErrorPopUp();
	...
	public void ValidateRLIfor4quaters(String startDate, String endDate) throws Exception
	{
		...
		String img1 = uiDriver.CaptureFullScreenShot("DateChange");
		reporter.addScreenshotToReport(img1, "DateChangeWarningMessage");
		Thread.sleep(10000);
	    uiDriver.SetValueForTextBox("StartDate",startDate);
	    uiDriver.ClearTextBox("EndDate");
	    img1 = uiDriver.CaptureFullScreenShot("DateChange");
		reporter.addScreenshotToReport(img1, "DateChangeWarningMessage");
		Thread.sleep(10000);
