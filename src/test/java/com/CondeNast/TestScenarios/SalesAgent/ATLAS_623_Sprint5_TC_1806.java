...
public class ATLAS_623_Sprint5_TC_1806 extends BaseTest
{
	...
	@Test
	public void VeirfyUnabletosetStageOpportunitytozeroifQLIis100() throws Exception
	{
		sl.NavigateandLogin();
		...
		String sval = opp.fillOpportunitiesForm(AccountName,"3000","10/03/2021","IdentifyingOpportunity","CentrallyBilled");
