...
public class ATLAS_1082_Sprint4_1476 extends BaseTest
{
	...
	@Test
	public void ValidateStagetoallotherstagesDownfrom90() throws Exception
	{
		sl.NavigateandLogin();
		...
		opp.fillOpportunitiesForm(AccountName,"18000","16/02/2021","IdentifyingOpportunity","CentrallyBilled");
		...
		createQuoteLine("Contracting (90%)");
		sname = getQLIdate();
		...
		opp.EditQuoteLine(sname);
		Thread.sleep(10000);
		opp.selectQLIStage("Identifying Opportunity (10%)");
		opp.SaveQuoteLineItem();
		getQLIdate();
