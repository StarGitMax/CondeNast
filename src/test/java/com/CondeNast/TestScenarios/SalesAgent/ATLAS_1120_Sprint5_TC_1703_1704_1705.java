...
public class ATLAS_1120_Sprint5_TC_1703_1704_1705 extends BaseTest
{
	...
	@Test
	public void RLIAmountValidationWhileEditQLI() throws Exception
	{
		...
		String sval = opp.fillOpportunitiesForm(AccountName,"18000","10/02/2021","IdentifyingOpportunity","NA");
		...
		opp.FillQuoteLineItemFields("6000","16/02/2021","30/06/2021","Digital");
		...
		Thread.sleep(1000);
		uiDriver.SetValueForTextBox("Budget", "10000");
		opp.RefreshRevenueSection();
		opp.fillRevenueLiesDetails("12000", "10");
		opp.SaveQuoteLineItemToCheckMandatoryFields();
		opp.fillRevenueLiesDetails("10000", "10");
		opp.SaveQuoteLineItem();
		...
		act.doubleClick(uiDriver.driver.findElement(By.xpath("//label[text()='Budget']/following-sibling::div/div/input"))).sendKeys(Keys.DELETE).build().perform();
		Thread.sleep(1000);
		uiDriver.SetValueForTextBox("Budget", "15000");
		opp.RefreshRevenueSection();
		...
		WebElement Quotes = uiDriver.driver.findElement(By.xpath("//a[text()='QUOTE LINES']"));
		JavascriptExecutor executor = (JavascriptExecutor)uiDriver.driver;
		executor.executeScript("arguments[0].click();", Quotes);
		Thread.sleep(10000);
		reporter.logger.log(Status.PASS, "Successfully Clicked on Quotes Link ");
		act = new Actions(uiDriver.driver);
		act.doubleClick(uiDriver.driver.findElement(By.xpath("//label[text()='Budget']/following-sibling::div/div/input"))).sendKeys(Keys.DELETE).build().perform();
		Thread.sleep(1000);
		uiDriver.SetValueForTextBox("Budget", "18000");
		opp.SelectAvailableMultipleMarkets("GCP HQ;Australia", "9000;9000");
		opp.RefreshRevenueSection();
		js = (JavascriptExecutor) uiDriver.driver;
		Element = uiDriver.driver.findElement(By.xpath("//td[text()='Total']/following-sibling::td[3]"));
		js.executeScript("arguments[0].scrollIntoView();", Element);
		Thread.sleep(5000);
		img1 = uiDriver.CaptureFullScreenShot("Date");
		reporter.addScreenshotToReport(img1, "ValidateRLI");
		opp.SaveQuoteLineItem();
