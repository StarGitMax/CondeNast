...
public class ATLAS_1120_Sprint5_TC_1701_1702 extends BaseTest
{
	...
	public void ValidateRLIforchangeinDates() throws Exception
	{
		...
		opp.FillQuoteLineItemFields("18000","16/11/2020","31/01/2021","Digital");
		...
		opp.CreateNewQuoteLineItem();
		opp.FillQuoteLineItemFields("18000","01/12/2020","30/05/2021","Digital");
		opp.SelectAvailableMultipleMarkets("GCP HQ;Australia", "6000;4000");
		opp.RefreshRevenueSection();
	    ...
	    uiDriver.SetValueForTextBox("StartDate","01/12/2020");
