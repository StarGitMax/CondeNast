...
public class ATLAS_762_Sprint3_TC_130_131 extends BaseTest
{
	...
	@Test
	public void UnallocatedAmountDisplayedCorectly() throws Exception
	{
		sl.NavigateandLogin();
		...
		opp.fillQuoteLiesDetails("GCP HQ", "2000");
		opp.fillQuoteLiesDetails("Australia", "1500");
		opp.SaveQuoteLineItem();
		rowcount = opp.getQuoteLineItemsCount();
