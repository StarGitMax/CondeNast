...
public class ATLAS_GCPSmoke_TC_023 extends BaseTest
{
	...
	public void  ValidateCloneQLIs() throws Exception
	{
		...
		opp.FillQuoteLineItemFields("6000","01/01/2021","30/06/2021","Digital");
	...
	public String getQLIdata() throws Exception
	{
		rowcount = opp.getQuoteLineItemsCount();
		...
		if(rowcount==4)
		{
			for(int j=3;j<=rowcount;j++)
			{
				...
				reporter.logger.log(Status.INFO, "***************************CHILD QLI: "+j+"*****************");
